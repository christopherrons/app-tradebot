...
class SimulationVolatilityTradeRunnerBuilder(VolatilityTradeRunnerBuilder):
    ...
    def build(self) -> VolatilityTradeRunner:
        ...
        self.__get_init_cache(initial_value, account_bid_price, account_ask_price)
    ...
    def __get_init_cache(self, initial_value: float, account_bid_price: float, account_ask_price: float):
