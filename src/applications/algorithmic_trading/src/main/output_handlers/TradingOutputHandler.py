...
class TradingOutputHandler:
    ...
    def __init__(self, is_live: bool,
        ...
        self.__plot_handler = PlotHandler(exchange_name, cash_currency, crypto_currency, database_service, is_live, trade_bot_cache.initial_value)
    ...
    def print_and_store_trade_report(self, is_buy: bool, fee: float, order_id: str):
        ...
        output = [datetime.now(), self.__is_live, self.__exchange_name, self.__trade_bot_cache.successful_trades, is_buy, price, quantity,
                  value, value - fee, fee]
